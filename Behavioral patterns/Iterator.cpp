...
//If you'll change collection type, 
//you should change methods ConcreteAggregate::add() & ConcreteAggregate::remove() & 
//Aggregate::operator[] or delete it ConcreteAggregate .
